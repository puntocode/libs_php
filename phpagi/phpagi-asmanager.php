<?php
  ...
  *
  * $Id: phpagi-asmanager.php 13270 2015-04-13 20:24:19Z endrigo $
  *
  ...
  */
  class AGI_AsteriskManager
  {
    ...
    */
    ...
    /**
     * Queue Pause.  Permite poner y sacar la pausa.
     *
     ...
     * 
     * @param String $queue Existing queue to pause member. This parameter is optional. If not supplied, the member will be paused in all queues that he/she is belong to.
     * @param String $member Member interface (sip/1000, zap/1-1, agent/1000, etc)?
     * @param String $paused Boolean for member initially paused or not (true or false)
     * 
