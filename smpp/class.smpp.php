...
//            die("$errstr ($errno)<br />");    
    ...
    /**
     * 
     * @param type $source_addr
     * @param type $destintation_addr
     * @param type $short_message
     * @param type $optional
     * @return type
     */
    ...
    /**
     * This function supports single and multipart messages.
     * The limit of characters is 160.
     *  
     * @param type $source_addr
     * @param type $destintation_addr
     * @param type $short_message
    ...
    function send_long($source_addr, $destintation_addr, $short_message, $utf = 0, $flash = 0) {
        ...
        if ($size < 160) { 
            ...
            if ($this->submit_sm($source_addr, $destintation_addr, $short_message) === false) {
